...
MDS = 0  # Minimum disparity for close-range depth calculation
...
# Initialize the StereoSGBM (Semi-Global Block Matching) object with updated parameters
...
# Load map settings from settings file
def load_map_settings(fName):
    ...
    with open(fName, 'r') as f:
        ...
        # Apply loaded parameters to StereoSGBM object
